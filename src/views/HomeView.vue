...
const navBarProps = computed(() => {
  ...
  // 在ai助手页面添加首页按钮
  if (route.path === "/ai-helper"||route.path === "/numberLevel") {
    return {
      showLeftSwitch: true,
      onClickLeft: onClickReturnHome,
    };
...
<template>
  <div
    class="max-w-md w-full flex flex-col flex-1 overflow-auto scrollbar-hide backdrop-blur-xl bg-white/50 rounded-lg sm:rounded-3xl sm:my-2"
  >
